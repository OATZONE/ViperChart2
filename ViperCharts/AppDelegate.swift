...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        homeViewController = HomePageViewController(nibName: "HomePageViewController", bundle: nil)
        navController = UINavigationController(rootViewController: homeViewController!)
        window?.rootViewController = homeViewController
        window?.makeKeyAndVisible()
        /*     loginViewController = LoginPageViewController(nibName: "LoginPageViewController", bundle: nil)
